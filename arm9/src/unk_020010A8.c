...
#define GF_PRINTCOLOR_MAKE(letter, shadow, ground)                                                 \
    (u32)((((letter)&GF_PRINTCOLOR_MASK) << GF_PRINTCOLOR_LETTER_SHIFT) |                          \
...
u32 FUN_02001354(struct BMPLIST_WORK *unk,
    struct BMPLIST_HEADER *bmplist,
    u16 list_p,
    u16 cursor_p,
    u16 print,
    u16 direct,
...
u32 FUN_020013C8(struct BMPLIST_WORK *unk,
    struct BMPLIST_HEADER *bmplist,
    u16 list_p,
    u16 cursor_p,
    u16 direct,
...
static void FUN_0200198C(struct BMPLIST_WORK *unk, u8 len, u8 mode)
{
    ...
    if (!mode)
    {
        FUN_0201A8C8(unk->hed.win,
            1,
            (u8)(len * yblk),
            (u8)((unk->hed.back_color << 4) | unk->hed.back_color));
    ...
    else
    {
        FUN_0201A8C8(unk->hed.win,
            ...
            (u8)((unk->hed.back_color << 4) | unk->hed.back_color));
        FUN_02001714(
            unk, (u16)(unk->lp + (unk->hed.line - len)), (u16)(unk->hed.line - len), (u16)len);
        FUN_020196F4(unk->hed.win,
            (u8)unk->hed.back_color,
            0,
            0,
